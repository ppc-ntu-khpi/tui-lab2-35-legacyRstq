...
public class CLIdemo {
        ...
        while ((line = readLine(reader, "")) != null) {
            if ("help".equals(line)) {
                ...
                AttributedStringBuilder a = new AttributedStringBuilder().append("\nThis is all of your ")
                        .append("customers", AttributedStyle.BOLD.foreground(AttributedStyle.RED)).append(":");
                ...
                if (Bank.getNumberOfCustomers() > 0) {
                    ...
                    for (int i = 0; i < Bank.getNumberOfCustomers(); i++) {
                        System.out
                                .println(Bank.getCustomer(i).getLastName() + "\t\t" + Bank.getCustomer(i).getFirstName()
    ...
    public static void main(String[] args) throws Exception {
        DataSource dataSource = new DataSource("C:\\Users\\Xiaomi\\Documents\\NetBeansProjects\\TUIdemo\\data\\test.dat");
        dataSource.loadData();
